...
buf.push("<a data-js=\"achivementCategory\" href=\"#allUserAchivement\" area-controls=\"allUserAchivement\"><li class=\"list-group-item\">" + (jade.escape(null == (jade_interp = categoryName) ? "" : jade_interp)) + "</li></a>");
    }
...
buf.push("</ul></div></div><div class=\"panel panel-default\"><div id=\"accountAccordion\" role=\"tab\" class=\"panel-heading\"><h4 class=\"panel-title\"><a data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#accountCollapse\" aria-expanded=\"false\" aria-controls=\"accountCollapse\" class=\"collapsed\"><i class=\"glyphicon glyphicon-chevron-right\"></i>各種アカウント</a></h4></div><div id=\"accountCollapse\" role=\"tabpanel\" aria-labelledby=\"accountAccordion\" class=\"panel-collapse collapse\"><ul role=\"\" class=\"list-group\"><li class=\"list-group-item\">hoge</li><li class=\"list-group-item\">hoge</li><li class=\"list-group-item\">hoge</li></ul></div></div></div></div><div class=\"panels\"><div id=\"allUserAchivement\" role=\"tabpanel\" data-js=\"achivementList\" class=\"panelcontent tab-pane fade\"><div class=\"row\"><div class=\"col-xs-12\"><div class=\"title text-center\">実績一覧</div></div></div><div id=\"achivementPanel\" data-js=\"achivementPanel\" class=\"hidden_panel_r\"></div></div></div>");}.call(this,"dashboard" in locals_for_with?locals_for_with.dashboard:typeof dashboard!=="undefined"?dashboard:undefined,"undefined" in locals_for_with?locals_for_with.undefined:typeof undefined!=="undefined"?undefined:undefined));;return buf.join("");
};
